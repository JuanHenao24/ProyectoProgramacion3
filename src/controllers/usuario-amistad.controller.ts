...
export class UsuarioAmistadController {
  ...
  async find(
    ...
    return this.usuarioRepository.amistad(id).find(filter);
  }
  ...
  async create(
    ...
    return this.usuarioRepository.amistad(id).create(amistad);
  }
  ...
  async patch(
    ...
    return this.usuarioRepository.amistad(id).patch(amistad, where);
  }
  ...
  async delete(
    ...
    return this.usuarioRepository.amistad(id).delete(where);
  }
}
